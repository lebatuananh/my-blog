      ...
      <div className="mx-auto max-w-3xl overflow-hidden">
        <div className="prose pt-7 text-gray-600 dark:text-gray-300">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">Company</strong>{" "}
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">Cookies</strong> are
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">Country</strong> refers
                to: Gujarat, India
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">Service</strong> refers
                to the Website.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">Usage Data</strong>{" "}
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">Website</strong> refers
                to Blog, accessible from{" "}
                <a
          ...
          <ul>
            ...
            <li>
              <strong className="dark:text-gray-100">Flash Cookies.</strong>{" "}
            ...
            <li>
              <strong className="dark:text-gray-100">Web Beacons.</strong>{" "}
          ...
          <ul>
            ...
            <li>
              <p>
                <strong className="dark:text-gray-100">To contact You:</strong>{" "}
          ...
          <ul>
            ...
            <li>
              <strong className="dark:text-gray-100">With Affiliates:</strong>{" "}
