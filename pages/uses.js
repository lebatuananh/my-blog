      ...
      <div className="mx-auto max-w-4xl divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="mt-5 mb-3 text-xs text-gray-500 dark:text-gray-400">
            Note: This page contains links to buy or download the products. If
            you click through and purchase, I do not receive any compensation
            for that purchase.
          </div>
        </div>
        ...
        <div className="pt-10">
          <span className="text-base text-gray-500 dark:text-gray-400">
            P.S. I am planning on remaking this site in the future, so stay
            around to see what I come up with ;)
          </span>
        </div>
      </div>
    </>
